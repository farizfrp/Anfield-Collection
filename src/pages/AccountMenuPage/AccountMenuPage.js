...
export default class AccountMenuPage extends Component {
 ...
 componentWillReceiveProps(nextProps) {
    ...
    />
        ...
        <View style={{ marginHorizontal: 30,paddingTop:140}}>
                            <Text><Icon active name="person" /> Akun Pembeli</Text>
        ...
        <Content>
          <ListItem onPress={()=>Actions.OrderListPage()} >
            <Left>
              ...
              <Text  style={{ left:20}}>Daftar Belanja</Text>
            </Left>
          ...
          <ListItem onPress={()=>Actions.ProfilePage()}>
            <Left>
              ...
              <Text style={{ left:20}}>Profile</Text>
            </Left>
          ...
          <ListItem onPress={()=>Actions.EditProfilePage()}>
            <Left>
              <Button style={{ backgroundColor: "#007AFF" }}>
                <Icon active name="person-add" />
             
              </Button>
              <Text style={{ left:20}}>Edit Profile</Text>
            </Left>
          ...
          <ListItem onPress={()=>Actions.AddressManagementPage()}>
            <Left>
              <Button style={{ backgroundColor: "#007AFF" }}>
                <Icon active name="pin" />
             
              </Button>
              <Text style={{ left:20}}>Atur Alamat</Text>
            </Left>
